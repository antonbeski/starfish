  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-10 space-y-6 md:space-y-12">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <Badge variant="outline" className="text-[9px] md:text-[10px] border-primary px-1.5 py-0 font-bold uppercase">LIVE</Badge>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-8 bg-white rounded-md border-2 border-primary p-5 md:p-8 shadow-md">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
              <div className="p-4 md:p-6 rounded-md bg-secondary border border-primary/10 text-center transition-all hover:border-primary">
                ...
                <p className="text-xl md:text-3xl font-mono font-bold">{loading ? '...' : history[history.length - 1]?.rsi?.toFixed(2)}</p>
              ...
              <div className="p-4 md:p-6 rounded-md bg-secondary border border-primary/10 text-center transition-all hover:border-primary">
                ...
                <p className="text-xl md:text-3xl font-mono font-bold">${loading ? '...' : history[history.length - 1]?.sma20?.toFixed(2)}</p>
              ...
              <div className="p-4 md:p-6 rounded-md bg-secondary border border-primary/10 text-center transition-all hover:border-primary">
                ...
                <p className="text-xl md:text-3xl font-mono font-bold">${loading ? '...' : history[history.length - 1]?.ema50?.toFixed(2)}</p>
      ...
      <footer className="pt-12 md:pt-16 pb-8 md:pb-12 border-t-2 border-primary text-center space-y-6 md:space-y-8">
        <div className="flex justify-center gap-4 md:gap-6 text-primary">
